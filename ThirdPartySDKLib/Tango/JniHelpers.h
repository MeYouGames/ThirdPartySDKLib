...
#ifndef __thirdpartysdk_tango__JniHelpers__
#define __thirdpartysdk_tango__JniHelpers__


class JniHelpers {
public:
	static void jniCommonVoidCall_Tango(const char* methodName, const char* classPath);
...
#endif /* defined(__thirdpartysdk_tango__JniHelpers__) */
